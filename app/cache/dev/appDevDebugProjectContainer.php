...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony2', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fd00e6906017b060560c7b48b10d1103f5a8625cdc121cabde9109fdad1cfb10');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('26d8b1f53da185e5a44e2a6b8523b11423c02f4b');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('thanh', '$2y$12$LRcWb6nbQLThLpjqmwDlouKAipzsITSwZcOUZ/hi5zpZKDnw/C2WW', array(0 => 'ROLE_USER')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$12$5Lm5LdKTh5lIAn0RIl3GXuBkympFg/bF4yCd4dZFZ8UDT9VjgoYqW', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '26d8b1f53da185e5a44e2a6b8523b11423c02f4b',
            'locale' => 'en',
            ...
            'kernel.secret' => '26d8b1f53da185e5a44e2a6b8523b11423c02f4b',
